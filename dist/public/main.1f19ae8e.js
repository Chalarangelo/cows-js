...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      var connection = new WebSocket("ws://".concat(this.state.host));

      connection.onopen = function () {
        return connection.send('Hello, I am a client!');
      };
    ...
    value: function receiveMessage(message) {
      if (this._isMounted) this.setState(function (state) {
        return {
          messages: _toConsumableArray(state.messages).concat([message.data])
        };
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        onChange: function onChange(evt) {
          return _this2.updateInputValue(evt.target.value);
        },
        id: "message-input",
        name: "message-input"
        ...
        id: "message-send"
      }, "Send "), _react.default.createElement("ul", {
        id: "message-list"
...
_reactDom.default.render(_react.default.createElement(_App.default, null), document.getElementById('root')); // document.addEventListener('DOMContentLoaded', () => {
